...
class ProcessaIntermediarioHolerites extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ProcessaIntermediarioHolerites';
    ...
    {
        // LOCAL DOS SCRIPTS
        $localScript = base_path().Storage::url('app/scripts_holerite')."/";
