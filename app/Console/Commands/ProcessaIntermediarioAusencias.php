...
class ProcessaIntermediarioAusencias extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ProcessaIntermediarioAusencias';
    ...
    {
        // LOCAL DOS SCRIPTS
        $localScript = base_path().Storage::url('app/scripts_ausencias')."/";
