...
class ProcessaIntermediarioTrocaEscalas extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ProcessaIntermediarioTrocaEscalas';
    ...
    {
        // LOCAL DOS SCRIPTS
        $localScript = base_path().Storage::url('app/scripts_troca_escalas')."/";
