...
class CriarRecibosFerias extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'CriarRecibosFerias';
    ...
    private function buscaAvisosPendetes(){
        ...
        "
            ...
            WHERE fa.NOME = 'Recibo de Férias'
    ...
    private function buscaDocumentoAviso($pendente){
        $this->info("Buscando Recibo Colaborador {$pendente->NUMCAD}.");
