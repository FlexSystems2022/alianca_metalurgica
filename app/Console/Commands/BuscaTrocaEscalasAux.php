...
class BuscaTrocaEscalasAux extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'BuscaTrocaEscalasAux';
    ...
    {
        $sql = "SELECT * FROM ".env('DB_OWNER')."NEXTI_RET_TROCA_ESCALAS WHERE ".env('DB_OWNER')."NEXTI_RET_TROCA_ESCALAS.ID = {$id}";
    ...
    private function addTrocaEscala($troca)
    {
        ...
        if ($trocaExistente) {
            ...
            $sql = "
                INSERT INTO ".env('DB_OWNER')."NEXTI_RET_TROCA_ESCALAS
    ...
    public function handle()
    {
        ...
        $retBuscaTrocaEscalas = $this->buscaTrocaEscalas();
    }
}
